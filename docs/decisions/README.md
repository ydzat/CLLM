...
| [0013](0013-unigram-plateau-and-wsd-lr-schedule.md) | Unigram plateau = transient local minimum; WSD LR | loss 卡在 unigram 熵是训练相变前的暂态平台（诱导头晚期才形成）；逃逸需高且不衰减的 LR → WSD(warmup→stable→decay)，cosine 过早衰减则永久卡死 |
